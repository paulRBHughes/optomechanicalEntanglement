...
for j, g in enumerate(gees):
    ...
    for i, z in enumerate(zetas):
        ...
        ax.loglog(t, corr, linewidth=2, linestyle=sts[i])


ax.set_xlabel(r"$\tilde{t}$")
threshold = ax.hlines(1, 0, tfs[0], linewidth=1.5, linestyles=":", label="entanglement", color='navy')
...
# first_legend = ax.legend(handles=[solid, threshold], title="$\zeta$")
